    ...
    <section className="delivery__information">
      <section className="delivery__information-row">
        <div className="delivery__information-items">
          <div className="delivery__information-column">
          ...
          <div className="delivery__information-learn-more">
            <div className="delivery__information-learn-more-inner">
              <Link
                className="delivery__information-learn-more-inner-a"
                to="delivery-information-learn-more"
              >
                Узнать подробнее
              </Link>
              <Route
                path="delivery-information-learn-more"
                component={DeliveryInformationLearnMore}
              />
            </div>
          </div>
